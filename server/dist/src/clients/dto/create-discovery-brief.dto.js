...
exports.CreateDiscoveryBriefDto = void 0;
const client_1 = require("@prisma/client");
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
const brief_question_dto_1 = require("./brief-question.dto");
const brief_requirement_dto_1 = require("./brief-requirement.dto");
class CreateDiscoveryBriefDto {
    title;
    status;
    meetingAt;
    projectType;
...
exports.CreateDiscoveryBriefDto = CreateDiscoveryBriefDto;
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsEnum)(client_1.BriefStatus),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => brief_requirement_dto_1.BriefRequirementDto),
...
__decorate([
    ...
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => brief_question_dto_1.BriefQuestionDto),
    __metadata("design:type", Array)
